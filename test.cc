...
// https://github.com/ClickHouse/ClickHouse/blob/d47a784900efe497366bfef75edc1a6cbe7599f7/programs/format/Format.cpp#L237C24-L237C27
...
int main(int argc, char **argv) {
  ...
  DB::ASTPtr ast = parseQuery(parser, pos, end, 0, 0, 0);
